...
execute if score &time_since_goat_horn_use check.callyourhappyghast matches 1 run function callyourhappyghast:teleport/teleport/forceload_add with storage callyourhappyghast:root

$execute if score &teleported check.callyourhappyghast matches 0 if entity @e[nbt={UUID:$(happy_ghast_UUID_from_horn)}] run function callyourhappyghast:teleport/teleport/teleport with storage callyourhappyghast:root
...
execute if score &time_since_goat_horn_use check.callyourhappyghast matches 25 run function callyourhappyghast:teleport/teleport/forceload_remove with storage callyourhappyghast:root
