...
# UUID check
execute if score &happy_ghast_owner callyourhappyghast.config matches 1 run data modify storage callyourhappyghast:root UUID set from entity @e[limit=1,tag=happy_ghast_to_call] data.Owner
execute if score &happy_ghast_owner callyourhappyghast.config matches 1 store success score &UUID_check check.callyourhappyghast run data modify storage callyourhappyghast:root UUID set from entity @s UUID
...
data modify storage callyourhappyghast:root happy_ghast_UUID_to_call set from entity @e[limit=1,tag=happy_ghast_to_call] UUID

data modify storage callyourhappyghast:root happy_ghast_UUID_to_call_0 set from entity @e[limit=1,tag=happy_ghast_to_call] UUID[0]

# get happy_ghast name
data modify storage callyourhappyghast:root happy_ghast_name set from entity @e[limit=1,tag=happy_ghast_to_call] CustomName

# execute give goat horn
execute as @s at @s if entity @e[limit=1,tag=happy_ghast_to_call] run function callyourhappyghast:goat_horn_give/goat_horn_give_macro with storage callyourhappyghast:root

tag @e[tag=happy_ghast_to_call] remove happy_ghast_to_call

data remove storage callyourhappyghast:root UUID
...
data remove storage callyourhappyghast:root happy_ghast_UUID_to_call
